...
class Model(nn.Module):
    ...
    #              single_step_output_One = 0, input_len_seg = 0, positionalE = False, modified = True, RIN=False):
        ...
        self.num_stacks = configs.num_stacks
        self.input_dim = configs.enc_in #input_dim
        self.input_len = configs.seq_len #input_len
        self.output_len = configs.pred_len #output_len
        self.hidden_size = configs.d_model #hid_size
        self.num_levels = configs.num_levels
        self.groups = configs.groups
        self.modified = configs.modified
        self.kernel_size = configs.kernel
        self.dropout = configs.dropout
        self.single_step_output_One = configs.single_step_output_One
        self.concat_len = configs.concat_len
        self.pe = configs.positionalE
        self.RIN=configs.RIN
        self.num_decoder_layer = configs.d_layers #num_decoder_layer
